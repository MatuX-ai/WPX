    ...
    <div class="flex flex-col gap-1">
      ...
      >
        <button
          ...
          class="rounded px-2 py-1 text-xs font-medium text-fg transition hover:bg-bg-muted hover:text-fg"
        ...
        <button
          ...
          aria-label="左环绕"
          class="rounded px-2 py-1 text-xs font-medium text-fg-muted transition hover:bg-bg-muted hover:text-fg"
