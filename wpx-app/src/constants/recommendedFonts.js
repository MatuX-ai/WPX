 ...
 * 推荐的中文免费字体清单。
 *
 * 与 backend `electron/services/recommended-fonts.js` 中的内容保持一致：
 ...
 *
 * 任何修改必须同步到 `electron/services/recommended-fonts.js`。
 */
export const RECOMMENDED_FREE_FONTS = [
  {
    id: 'source-han-soft',
    name: '思源柔黑',
    category: '黑体',
...
export function getRecommendedFreeFonts() {
